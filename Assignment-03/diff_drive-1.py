...
class World:
    ...
    def valid_point(self,x,y,theta):
        ...
        collision_check3 = self.intersection_check(boundary,self.vehicle2)
    ...
    def hurestic_function(self,x,y,theta,vl,vr):
        _theta = 0
        theta = (theta+360)%360
        vel = (vl+vr)/2
        reverse_penalty = 0
        ...
        hurestic = distance + _theta + reverse_penalty + parking_penalty
        return hurestic
    ...
    def straight_available(self,x,y):
        ...
        if (self.intersection_check(boundary_line,self.obstacle)) or (self.intersection_check(boundary_line,self.vehicle1)):
            return False
        return True
    ...
    def A_star_algo(self):
        ...
        while len(queue) > 0:
            ...
            queue.pop(index)
            if not (self.visit_checker((round(shortest[0]),round(shortest[1]),round(shortest[2])),visited)):
                ...
                for neighbour in neighbours:
                    ...
                    t_f = t_g +(0.9*self.hurestic_function(neighbour[0],neighbour[1],neighbour[2],vl,vr))
