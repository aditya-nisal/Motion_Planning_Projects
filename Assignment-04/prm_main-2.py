...
from  wildfire_prm import Environment1
from  wildfire_prm import prm_planner
from  wildfire_astar import Environment
from  wildfire_astar import astar_planner
import prm
...
while total_time<3600: 
    ...
    if (got_data == 'null'): #len(heap)==0 or
        ...
        robot_size = 5
        rx, ry = prm.prm_planning(start[0], start[1], end[0], end[1], obs_list_inflated_x, obs_list_inflated_y, robot_size)
